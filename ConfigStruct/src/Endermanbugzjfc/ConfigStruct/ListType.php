...
class ListType
{
     ...
     *
     * If multiple candidates are provided, only the one with least unhandled elements will be used. Incompatible structs will never be used. If there is no suitable struct for an element, that element will not be parsed, raw values will be returned. An {@link InvalidListTypeError} will be added to the errors tree during parse time.
